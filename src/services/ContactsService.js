...
class ContactsService{
    ...
    return this.httpClient.get(`/contacts?orderBy=${orderBy}`); //passo como argumento a url, no caso nao mais a url e sim o path, pois vou centralizar e a camada q trata da requisição tá abstraida tb...acesso o this.httpclient pois é lá q tá salvo a instancia, dai quando acesso ela cede a url q tá fixada a baseurl.. desacompla pois consigo usar diferentes base url, basta fazer uma instancia
    }
